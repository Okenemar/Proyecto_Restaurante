			...
			<div id="carouselExampleCaptions" class="carousel slide"
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="fotos/minimalista-plana-pone-ravioles-negros-plato.jpg"
					...
					<div class="carousel-item">
						<img src="fotos/solomillo.jpg" class="d-block w-50 h-50" alt="">
						<div class="carousel-caption d-none d-md-block">
							<h5>Solomillo</h5>
...
<footer class="text-center text-lg-start bg-white text-muted">
  ...
  <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
    ...
    <div class="me-5 d-none d-lg-block">
      <span>Ponte en contacto con nosotros mediante nuestras redes sociales:</span>
    </div>
    <!-- Left -->
...
</svg>Calle la Concha 123, Donosti</p>
          <p>
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.025);">
    © 2023 Copyright:
    <a class="text-reset fw-bold">HerreroMartinez.com</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
